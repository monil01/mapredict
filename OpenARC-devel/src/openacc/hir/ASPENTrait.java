...
public class ASPENTrait extends ASPENExpression {
    ...
    private static HashSet<String> memory_traits = 
    		new HashSet<String>(Arrays.asList("stride", "random", "pattern", "initialized", "algorithm", "factor", "correction"));
	...
	private void checkTrait(String str) {
		if( parallelism_traits.contains(str) ) {
			...
			System.err.println("[INFO from ASPENTrait.checkTrait()] Found an unknown ASPEN trait: " + str);
			//System.err.println("Exit the ASPEN Model Generator.");
			//System.exit(0);
			tType = ASPENTrait.TraitType.CustomTrait;
			trait = str;
		}
	}
