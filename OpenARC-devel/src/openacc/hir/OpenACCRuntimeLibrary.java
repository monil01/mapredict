...
public class OpenACCRuntimeLibrary
{
  ...
  */
  private void addEntries()
  {
    ...
    add("acc_map_data_forced",     Property.OPENARC_EXTENSION, Property.CONFIG_API);
    add("acc_copyin_async_wait",     Property.OPENARC_EXTENSION, Property.MEMORY_API, Property.DEVICE_MALLOC, Property.MEM_COPYIN);
    add("acc_pcopyin_async_wait",     Property.OPENARC_EXTENSION, Property.MEMORY_API, Property.DEVICE_MALLOC, Property.MEM_COPYIN);
    add("acc_present_or_copyin_async_wait",     Property.OPENARC_EXTENSION, Property.MEMORY_API, Property.DEVICE_MALLOC, Property.MEM_COPYIN);
    add("acc_create_async_wait",     Property.OPENARC_EXTENSION, Property.MEMORY_API, Property.DEVICE_MALLOC);
    add("acc_pcreate_async_wait",     Property.OPENARC_EXTENSION, Property.MEMORY_API, Property.DEVICE_MALLOC);
    add("acc_present_or_create_async_wait",     Property.OPENARC_EXTENSION, Property.MEMORY_API, Property.DEVICE_MALLOC);
    add("acc_copyout_async_wait",     Property.OPENARC_EXTENSION, Property.MEMORY_API, Property.DEVICE_MALLOC, Property.MEM_COPYOUT);
    add("acc_delete_async_wait",     Property.OPENARC_EXTENSION, Property.MEMORY_API, Property.DEVICE_FREE);
  }
