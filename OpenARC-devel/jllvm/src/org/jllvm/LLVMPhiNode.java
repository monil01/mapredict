...
public class LLVMPhiNode extends LLVMInstruction {
	public LLVMPhiNode(LLVMInstructionBuilder builder,String name,LLVMType type) {
		this(Core.LLVMBuildPhi(builder.getInstance(),type.getInstance(),name));
	}
	...
	public LLVMPhiNode(SWIGTYPE_p_LLVMOpaqueValue c) {
		super(c);
	}
}
