...
public class LLVMXorInstruction extends LLVMInstruction {
	private static SWIGTYPE_p_LLVMOpaqueValue buildInstruction(LLVMInstructionBuilder builder,LLVMValue lhs,LLVMValue rhs,String name) {
		return Core.LLVMBuildXor(builder.getInstance(),lhs.getInstance(),rhs.getInstance(),name);
	}
	...
	public LLVMXorInstruction(SWIGTYPE_p_LLVMOpaqueValue c) {
		super(c);
	}
}
