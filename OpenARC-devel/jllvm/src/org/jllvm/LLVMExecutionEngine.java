...
public class LLVMExecutionEngine {
	...
	public LLVMFunction findFunction(String name) {
		...
		if(success && result != null)
			return (LLVMFunction)LLVMValue.getValue(result);
		else
			return null;
	}
	...
	/**
	 * Be sure to call this before disposing of the {@link LLVMContext} with
	 * which its {@link LLVMModule}s are associated, and do not use or dispose
	 * of its {@link LLVMModule}s afterward.
	 */
	public void dispose() {
