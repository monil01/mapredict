...
public class Core {
  ...
  public static SWIGTYPE_p_LLVMOpaqueType LLVMMetadataTypeInContext(SWIGTYPE_p_LLVMOpaqueContext C) {
    long cPtr = CoreJNI.LLVMMetadataTypeInContext(SWIGTYPE_p_LLVMOpaqueContext.getCPtr(C));
    return (cPtr == 0) ? null : new SWIGTYPE_p_LLVMOpaqueType(cPtr, false);
  }
  ...
  public static SWIGTYPE_p_LLVMOpaqueType LLVMMetadataType() {
    long cPtr = CoreJNI.LLVMMetadataType();
    return (cPtr == 0) ? null : new SWIGTYPE_p_LLVMOpaqueType(cPtr, false);
  }
  ...
  public static SWIGTYPE_p_LLVMOpaqueValue LLVMMDNodeTemporaryInContext(SWIGTYPE_p_LLVMOpaqueContext C, SWIGTYPE_p_p_LLVMOpaqueValue Vals, long Count) {
    long cPtr = CoreJNI.LLVMMDNodeTemporaryInContext(SWIGTYPE_p_LLVMOpaqueContext.getCPtr(C), SWIGTYPE_p_p_LLVMOpaqueValue.getCPtr(Vals), Count);
    return (cPtr == 0) ? null : new SWIGTYPE_p_LLVMOpaqueValue(cPtr, false);
  }

  public static SWIGTYPE_p_LLVMOpaqueValue LLVMMDNodeTemporary(SWIGTYPE_p_p_LLVMOpaqueValue Vals, long Count) {
    long cPtr = CoreJNI.LLVMMDNodeTemporary(SWIGTYPE_p_p_LLVMOpaqueValue.getCPtr(Vals), Count);
    return (cPtr == 0) ? null : new SWIGTYPE_p_LLVMOpaqueValue(cPtr, false);
  }

  public static void LLVMDeleteMDNodeTemporary(SWIGTYPE_p_LLVMOpaqueValue V) {
    CoreJNI.LLVMDeleteMDNodeTemporary(SWIGTYPE_p_LLVMOpaqueValue.getCPtr(V));
  }
  ...
  public static void LLVMReplaceMDNodeOperandWith(SWIGTYPE_p_LLVMOpaqueValue V, long I, SWIGTYPE_p_LLVMOpaqueValue Op) {
    CoreJNI.LLVMReplaceMDNodeOperandWith(SWIGTYPE_p_LLVMOpaqueValue.getCPtr(V), I, SWIGTYPE_p_LLVMOpaqueValue.getCPtr(Op));
  }
