...
/**
 * Obtain a temporary MDNode value from a context.
 *
 * @see llvm::MDNode::getTemporary()
 */
LLVMValueRef LLVMMDNodeTemporaryInContext(LLVMContextRef C, LLVMValueRef *Vals,
                                          unsigned Count);

/**
 * Obtain a temporary MDNode value from the global context.
 *
 * @see llvm::MDNode::getTemporary()
 */
LLVMValueRef LLVMMDNodeTemporary(LLVMValueRef *Vals, unsigned Count);

/**
 * Deallocate a temporary MDNode.
 *
 * @see llvm::MDNode::deleteTemporary()
 */
void LLVMDeleteMDNodeTemporary(LLVMValueRef V);
...
/**
 * Replace a specific operand of the given MDNode.
 *
 * @see llvm::MDNode::replaceOperandWith()
 */
void LLVMReplaceMDNodeOperandWith(LLVMValueRef V, unsigned I, LLVMValueRef Op);
