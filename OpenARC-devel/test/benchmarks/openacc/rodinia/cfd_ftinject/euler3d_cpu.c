...
#elif R_MODE == 1
    #pragma openarc resilience ftregion FTTHREAD ftcond(RES_REGION4) ftkind(FTKIND) num_faults(TOTAL_NUM_FAULTS) num_ftbits(NUM_FAULTYBITS)
#elif R_MODE == 2
    #pragma openarc resilience ftregion FTTHREAD ftcond(RES_REGION4) ftprofile(count4) ftdata(FTVAR4) num_faults(0) num_ftbits(0)
#elif R_MODE == 3
    #pragma openarc resilience ftregion FTTHREAD ftcond(RES_REGION4) ftprofile(count4) ftkind(FTKIND) num_faults(0) num_ftbits(0)
#elif R_MODE == 4
    #pragma openarc resilience ftregion FTTHREAD ftcond(RES_REGION4) ftpredict(FTCNT4) ftdata(FTVAR4) num_faults(TOTAL_NUM_FAULTS) num_ftbits(NUM_FAULTYBITS)
#elif R_MODE == 5
    #pragma openarc resilience ftregion FTTHREAD ftcond(RES_REGION4) ftpredict(FTCNT4) ftkind(FTKIND) num_faults(TOTAL_NUM_FAULTS) num_ftbits(NUM_FAULTYBITS)
#endif
