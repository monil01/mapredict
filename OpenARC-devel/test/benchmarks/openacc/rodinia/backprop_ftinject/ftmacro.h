...
#pragma openarc #define FTCNT0 26215328
#else
...
#pragma openarc #define FTCNT1 433
#else
...
#pragma openarc #define FTCNT2 1130
#elif _FTVAR == 1
...
#pragma openarc #define FTCNT3 51512876
#elif _FTVAR == 1
...
#if _FTKIND == 0
#pragma openarc #define FTCNT0 14680624
#elif _FTKIND == 1
#pragma openarc #define FTCNT0 10486160
#elif _FTKIND == 2
#pragma openarc #define FTCNT0 5243040
#elif _FTKIND == 3
#pragma openarc #define FTCNT0 5243040
#elif _FTKIND == 4
#pragma openarc #define FTCNT0 19923664
#elif _FTKIND == 5
#pragma openarc #define FTCNT0 15729200
#elif _FTKIND == 6
#pragma openarc #define FTCNT0 17826384
#else
#pragma openarc #define FTCNT0 6291648
#endif

#if _FTKIND == 0
#pragma openarc #define FTCNT1 245
#elif _FTKIND == 1
#pragma openarc #define FTCNT1 175
#elif _FTKIND == 2
#pragma openarc #define FTCNT1 85
#elif _FTKIND == 3
#pragma openarc #define FTCNT1 85
#elif _FTKIND == 4
#pragma openarc #define FTCNT1 330
#elif _FTKIND == 5
#pragma openarc #define FTCNT1 260
#elif _FTKIND == 6
#pragma openarc #define FTCNT1 292
#else
#pragma openarc #define FTCNT1 102
#endif

#if _FTKIND == 0
#pragma openarc #define FTCNT2 670
#elif _FTKIND == 1
#pragma openarc #define FTCNT2 464
#elif _FTKIND == 2
#pragma openarc #define FTCNT2 221
#elif _FTKIND == 3
#pragma openarc #define FTCNT2 187
#elif _FTKIND == 4
#pragma openarc #define FTCNT2 891
#elif _FTKIND == 5
#pragma openarc #define FTCNT2 651
#elif _FTKIND == 6
#pragma openarc #define FTCNT2 751
#else
#pragma openarc #define FTCNT2 272
#endif

#if _FTKIND == 0
#pragma openarc #define FTCNT3 25166599
#elif _FTKIND == 1
#pragma openarc #define FTCNT3 16515581
#elif _FTKIND == 2
#pragma openarc #define FTCNT3 13631904
#elif _FTKIND == 3
#pragma openarc #define FTCNT3 11534688
#elif _FTKIND == 4
#pragma openarc #define FTCNT3 38798503
#elif _FTKIND == 5
#pragma openarc #define FTCNT3 28050269
#elif _FTKIND == 6
#pragma openarc #define FTCNT3 39257265
#else
#pragma openarc #define FTCNT3 16777728
#endif
