...
#if _FTVAR == 0
#pragma openarc #define FTVAR0 x[0:SIZE]
#pragma openarc #define FTCNT0 41344943700
#elif _FTVAR == 1
#pragma openarc #define FTVAR0 y[0:SIZE]
#pragma openarc #define FTCNT0 41344943700
#elif _FTVAR == 2
#pragma openarc #define FTVAR0 values[0:NZR]
#pragma openarc #define FTCNT0 41344943700
#elif _FTVAR == 3
#pragma openarc #define FTVAR0 colind[0:NZR]
#pragma openarc #define FTCNT0 41344943700
#else
#pragma openarc #define FTVAR0 rowptr[0:SIZE+1]
#pragma openarc #define FTCNT0 41344943700
#endif

#if _FTVAR == 0
#pragma openarc #define FTVAR1 x[0:SIZE]
#pragma openarc #define FTCNT1 16485535506
#else
#pragma openarc #define FTVAR1 y[0:SIZE]
#pragma openarc #define FTCNT1 16485535506
#endif
...
#if _FTKIND == 0
#pragma openarc #define FTCNT0 30763134500
#elif _FTKIND == 1
#pragma openarc #define FTCNT0 24646832000
#elif _FTKIND == 2
#pragma openarc #define FTCNT0 4271520900
#elif _FTKIND == 3
#pragma openarc #define FTCNT0 4065171500
#elif _FTKIND == 4
#pragma openarc #define FTCNT0 35034655400
#elif _FTKIND == 5
#pragma openarc #define FTCNT0 28712003500
#elif _FTKIND == 6
#pragma openarc #define FTCNT0 26466886500
#else
#pragma openarc #define FTCNT0 7936356900
#endif

#if _FTKIND == 0
#pragma openarc #define FTCNT1 12434877940
#elif _FTKIND == 1
#pragma openarc #define FTCNT1 9135930775
#elif _FTKIND == 2
#pragma openarc #define FTCNT1 2265560869
#elif _FTKIND == 3
#pragma openarc #define FTCNT1 1785506446
#elif _FTKIND == 4
#pragma openarc #define FTCNT1 14700438809
#elif _FTKIND == 5
#pragma openarc #define FTCNT1 10921437221
#elif _FTKIND == 6
#pragma openarc #define FTCNT1 8722002528
#else
#pragma openarc #define FTCNT1 1579157046
#endif
