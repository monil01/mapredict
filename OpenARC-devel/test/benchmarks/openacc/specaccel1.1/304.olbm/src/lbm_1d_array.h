...
typedef double LBM_Grid[SIZE_Z*SIZE_Y*SIZE_X*N_CELL_ENTRIES_];
typedef LBM_Grid* LBM_GridPtr;

/*############################################################################*/

#define CALC_INDEX(x,y,z,e) ((e)+N_CELL_ENTRIES_*((x)+ \
...
#define SWEEP_X  ((i / N_CELL_ENTRIES_) % SIZE_X)
#define SWEEP_Y (((i / N_CELL_ENTRIES_) / SIZE_X) % SIZE_Y)
#define SWEEP_Z  ((i / N_CELL_ENTRIES_) / (SIZE_X*SIZE_Y))
