...
int main(int argc, char *argv[])
{
  ...
  nz2 = grid_points[2] - 2;
  if( nx2 != NX2 ) {
    printf("Wrong macro value for NX2 (%d); it should be %d!; exit!\n", NX2, nx2);
    exit(1);
  }
  if( ny2 != NY2 ) {
    printf("Wrong macro value for NX2 (%d); it should be %d!; exit!\n", NY2, ny2);
...
#ifndef USE_STATICMEM
#ifdef USE_UNIFIEDMEM
  u=(double (*)[KMAX][JMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*5*KMAX*(JMAXP+1)*(IMAXP+1));
  us=(double (*)[JMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*KMAX*(JMAXP+1)*(IMAXP+1));
  vs=(double (*)[JMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*KMAX*(JMAXP+1)*(IMAXP+1));
  ws=(double (*)[JMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*KMAX*(JMAXP+1)*(IMAXP+1));
  qs=(double (*)[JMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*KMAX*(JMAXP+1)*(IMAXP+1));
  rho_i=(double (*)[JMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*KMAX*(JMAXP+1)*(IMAXP+1));
  speed=(double (*)[JMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*KMAX*(JMAXP+1)*(IMAXP+1));
  square=(double (*)[JMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*KMAX*(JMAXP+1)*(IMAXP+1));
  rhs=(double (*)[KMAX][JMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*5*KMAX*(JMAXP+1)*(IMAXP+1));
  forcing=(double (*)[KMAX][JMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*5*KMAX*(JMAXP+1)*(IMAXP+1));
#else
  u=(double (*)[KMAX][JMAXP+1][IMAXP+1])malloc(sizeof(double)*5*KMAX*(JMAXP+1)*(IMAXP+1));
  ...
  rhs=(double (*)[KMAX][JMAXP+1][IMAXP+1])malloc(sizeof(double)*5*KMAX*(JMAXP+1)*(IMAXP+1));
  forcing=(double (*)[KMAX][JMAXP+1][IMAXP+1])malloc(sizeof(double)*5*KMAX*(JMAXP+1)*(IMAXP+1));
#endif
#endif

  set_constants();

#pragma acc data create(u[0:5][0:KMAX][0:(JMAXP+1)][0:(IMAXP+1)],us[0:KMAX][0:(JMAXP+1)][0:(IMAXP+1)],vs[0:KMAX][0:(JMAXP+1)][0:(IMAXP+1)],ws[0:KMAX][0:(JMAXP+1)][0:(IMAXP+1)],qs[0:KMAX][0:(JMAXP+1)][0:(IMAXP+1)],rho_i[0:KMAX][0:(JMAXP+1)][0:(IMAXP+1)],speed[0:KMAX][0:(JMAXP+1)][0:(IMAXP+1)],square[0:KMAX][0:(JMAXP+1)][0:(IMAXP+1)],forcing[0:5][0:KMAX][0:(JMAXP+1)][0:(IMAXP+1)],rhs[0:5][0:KMAX][0:(JMAXP+1)][0:(IMAXP+1)])
{
  exact_rhs();
