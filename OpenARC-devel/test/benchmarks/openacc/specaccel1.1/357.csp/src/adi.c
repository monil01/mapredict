...
#ifdef USE_ASYNC
#pragma acc kernels present(rhs) async(0)
#else
...
#ifdef USE_ASYNC
#pragma acc kernels present(us,vs,ws,qs,u,speed,rhs) async(0)
#else
...
*/
  double (*lhsX)[NZ2+1][IMAXP+1][IMAXP+1];
  double (*lhspX)[NZ2+1][IMAXP+1][IMAXP+1];
  double (*lhsmX)[NZ2+1][IMAXP+1][IMAXP+1];
  double (*rhonX)[IMAXP+1][PROBLEM_SIZE];
  double (*rhsX)[NZ2+1][IMAXP+1][JMAXP+1];

#ifdef USE_UNIFIEDMEM
  lhsX = (double (*)[NZ2+1][IMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*5*(NZ2+1)*(IMAXP+1)*(IMAXP+1));
  lhspX = (double (*)[NZ2+1][IMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*5*(NZ2+1)*(IMAXP+1)*(IMAXP+1));
  lhsmX = (double (*)[NZ2+1][IMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*5*(NZ2+1)*(IMAXP+1)*(IMAXP+1));
  rhonX = (double (*)[IMAXP+1][PROBLEM_SIZE])acc_create_unified(NULL, sizeof(double)*(NZ2+1)*(IMAXP+1)*(PROBLEM_SIZE));
  rhsX = (double (*)[NZ2+1][IMAXP+1][JMAXP+1])acc_create_unified(NULL, sizeof(double)*5*(NZ2+1)*(IMAXP+1)*(JMAXP+1));
#else
  lhsX = (double (*)[NZ2+1][IMAXP+1][IMAXP+1])malloc(sizeof(double)*5*(NZ2+1)*(IMAXP+1)*(IMAXP+1));
  lhspX = (double (*)[NZ2+1][IMAXP+1][IMAXP+1])malloc(sizeof(double)*5*(NZ2+1)*(IMAXP+1)*(IMAXP+1));
  lhsmX = (double (*)[NZ2+1][IMAXP+1][IMAXP+1])malloc(sizeof(double)*5*(NZ2+1)*(IMAXP+1)*(IMAXP+1));
  rhonX = (double (*)[IMAXP+1][PROBLEM_SIZE])malloc(sizeof(double)*(NZ2+1)*(IMAXP+1)*(PROBLEM_SIZE));
  rhsX = (double (*)[NZ2+1][IMAXP+1][JMAXP+1])malloc(sizeof(double)*5*(NZ2+1)*(IMAXP+1)*(JMAXP+1));
#endif
...
#pragma acc data present(rho_i,us,speed,rhs) create(lhsX[0:5][0:NZ2+1][0:IMAXP+1][0:IMAXP+1],lhspX[0:5][0:NZ2+1][0:IMAXP+1][0:IMAXP+1],lhsmX[0:5][0:NZ2+1][0:IMAXP+1][0:IMAXP+1],rhonX[0:NZ2+1][0:IMAXP+1][0:PROBLEM_SIZE],rhsX[0:5][0:NZ2+1][0:IMAXP+1][0:JMAXP+1])
{  
...
#pragma acc wait(0)
  ...
  acc_delete_unified(lhspX, 0);
  acc_delete_unified(lhsmX, 0);
  acc_delete_unified(rhonX, 0);
  acc_delete_unified(rhsX, 0);
#else
  free(lhsX);
  free(lhspX);
  free(lhsmX);
...
*/
  double (*lhsY)[NZ2+1][IMAXP+1][IMAXP+1];
  double (*lhspY)[NZ2+1][IMAXP+1][IMAXP+1];
  double (*lhsmY)[NZ2+1][IMAXP+1][IMAXP+1];
  double (*rhoqY)[IMAXP+1][PROBLEM_SIZE];

#ifdef USE_UNIFIEDMEM
  lhsY = (double (*)[NZ2+1][IMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*5*(NZ2+1)*(IMAXP+1)*(IMAXP+1));
  lhspY = (double (*)[NZ2+1][IMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*5*(NZ2+1)*(IMAXP+1)*(IMAXP+1));
  lhsmY = (double (*)[NZ2+1][IMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*5*(NZ2+1)*(IMAXP+1)*(IMAXP+1));
  rhoqY = (double (*)[IMAXP+1][PROBLEM_SIZE])acc_create_unified(NULL, sizeof(double)*(NZ2+1)*(IMAXP+1)*(PROBLEM_SIZE));
#else
  lhsY = (double (*)[NZ2+1][IMAXP+1][IMAXP+1])malloc(sizeof(double)*5*(NZ2+1)*(IMAXP+1)*(IMAXP+1));
  lhspY = (double (*)[NZ2+1][IMAXP+1][IMAXP+1])malloc(sizeof(double)*5*(NZ2+1)*(IMAXP+1)*(IMAXP+1));
  lhsmY = (double (*)[NZ2+1][IMAXP+1][IMAXP+1])malloc(sizeof(double)*5*(NZ2+1)*(IMAXP+1)*(IMAXP+1));
  rhoqY = (double (*)[IMAXP+1][PROBLEM_SIZE])malloc(sizeof(double)*(NZ2+1)*(IMAXP+1)*(PROBLEM_SIZE));
#endif
...
#pragma acc data present(rho_i,vs,speed,rhs) create(lhsY[0:5][0:NZ2+1][0:IMAXP+1][0:IMAXP+1],lhspY[0:5][0:NZ2+1][0:IMAXP+1][0:IMAXP+1],lhsmY[0:5][0:NZ2+1][0:IMAXP+1][0:IMAXP+1],rhoqY[0:NZ2+1][0:IMAXP+1][0:PROBLEM_SIZE])
{
#ifdef USE_ASYNC
  #pragma acc kernels loop async(0)
#else
...
#pragma acc wait(0)
  ...
  acc_delete_unified(lhspY, 0);
  acc_delete_unified(lhsmY, 0);
  acc_delete_unified(rhoqY, 0);
#else
  free(lhsY);
  free(lhspY);
  free(lhsmY);
...
*/
  double (*lhsZ)[NY2+1][IMAXP+1][IMAXP+1];
  double (*lhspZ)[NY2+1][IMAXP+1][IMAXP+1];
  double (*lhsmZ)[NY2+1][IMAXP+1][IMAXP+1];
  double (*rhosZ)[IMAXP+1][PROBLEM_SIZE];
#ifdef USE_UNIFIEDMEM
  lhsZ = (double (*)[NY2+1][IMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*5*(NY2+1)*(IMAXP+1)*(IMAXP+1));
  lhspZ = (double (*)[NY2+1][IMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*5*(NY2+1)*(IMAXP+1)*(IMAXP+1));
  lhsmZ = (double (*)[NY2+1][IMAXP+1][IMAXP+1])acc_create_unified(NULL, sizeof(double)*5*(NY2+1)*(IMAXP+1)*(IMAXP+1));
  rhosZ = (double (*)[IMAXP+1][PROBLEM_SIZE])acc_create_unified(NULL, sizeof(double)*(NY2+1)*(IMAXP+1)*(PROBLEM_SIZE));
#else
  lhsZ = (double (*)[NY2+1][IMAXP+1][IMAXP+1])malloc(sizeof(double)*5*(NY2+1)*(IMAXP+1)*(IMAXP+1));
  lhspZ = (double (*)[NY2+1][IMAXP+1][IMAXP+1])malloc(sizeof(double)*5*(NY2+1)*(IMAXP+1)*(IMAXP+1));
  lhsmZ = (double (*)[NY2+1][IMAXP+1][IMAXP+1])malloc(sizeof(double)*5*(NY2+1)*(IMAXP+1)*(IMAXP+1));
  rhosZ = (double (*)[IMAXP+1][PROBLEM_SIZE])malloc(sizeof(double)*(NY2+1)*(IMAXP+1)*(PROBLEM_SIZE));
#endif
...
#pragma acc data present(rho_i,ws,speed,rhs) create(lhsZ[0:5][0:NY2+1][0:IMAXP+1][0:IMAXP+1],lhspZ[0:5][0:NY2+1][0:IMAXP+1][0:IMAXP+1],lhsmZ[0:5][0:NY2+1][0:IMAXP+1][0:IMAXP+1],rhosZ[0:NY2+1][0:IMAXP+1][0:PROBLEM_SIZE])
{
#ifdef USE_ASYNC
  #pragma acc kernels loop async(0)
#else
...
#pragma acc wait(0)
  ...
  acc_delete_unified(lhspZ, 0);
  acc_delete_unified(lhsmZ, 0);
  acc_delete_unified(rhosZ, 0);
#else
  free(lhsZ);
  free(lhspZ);
  free(lhsmZ);
