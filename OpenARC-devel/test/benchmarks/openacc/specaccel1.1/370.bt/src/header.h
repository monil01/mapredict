...
#ifdef _OPENARC_
#pragma openarc #define IMAX      PROBLEM_SIZE
#pragma openarc #define JMAX      PROBLEM_SIZE
#pragma openarc #define KMAX      PROBLEM_SIZE
#pragma openarc #define IMAXP     IMAX/2*2
#pragma openarc #define JMAXP     JMAX/2*2
#endif
...
void verify(int no_time_steps, char *classT, logical *verified);
