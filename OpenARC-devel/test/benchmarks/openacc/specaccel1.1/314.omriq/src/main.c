...
main (int argc, char *argv[]) {
  ...
  kVals = (struct kValues*)acc_create_unified(NULL, numK * sizeof (struct kValues));
#else
...
#ifdef USE_UNIFIEDMEM
  acc_delete_unified (kx, 0);
  acc_delete_unified (ky, 0);
  acc_delete_unified (kz, 0);
  acc_delete_unified (x, 0);
  acc_delete_unified (y, 0);
  acc_delete_unified (z, 0);
  acc_delete_unified (phiR, 0);
  acc_delete_unified (phiI, 0);
  acc_delete_unified (phiMag, 0);
  acc_delete_unified (kVals, 0);
  acc_delete_unified (Qr, 0);
  acc_delete_unified (Qi, 0);
#else
  free (kx);
  free (ky);
  free (kz);
