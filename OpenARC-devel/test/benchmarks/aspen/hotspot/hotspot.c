...
/*
#pragma acc data \
		copyin(power[0:POWER_SIZE]), \
		copy(temp[0:TEMP_SIZE]), \
...
#pragma acc parallel 
{
				...
				//#pragma acc cuda permute(c,r)
				for (r = 0; r < ROW_SIZE; r++) {
				#pragma acc loop worker
				for (c = 0; c < COL_SIZE; c++) {
						/*	Corner 1	*/
#pragma aspen declare param(aspen_param_boundary_prob1:0.01)
#pragma aspen declare param(aspen_param_boundary_prob2:0.01)
#pragma aspen declare param(aspen_param_boundary_prob3:0.01)
#pragma aspen declare param(aspen_param_boundary_prob4:0.01)
#pragma aspen declare param(aspen_param_boundary_prob5:0.01)
#pragma aspen declare param(aspen_param_boundary_prob6:0.01)
#pragma aspen declare param(aspen_param_boundary_prob7:0.01)
#pragma aspen declare param(aspen_param_boundary_prob8:0.01)
#pragma aspen control probability(aspen_param_boundary_prob1, aspen_param_boundary_prob2, aspen_param_boundary_prob3,aspen_param_boundary_prob4,aspen_param_boundary_prob5,aspen_param_boundary_prob6,aspen_param_boundary_prob7,aspen_param_boundary_prob8)
						if ( (r == 0) && (c == 0) ) {
...
{
#pragma aspen declare param(grid_rows:ROW_SIZE, grid_cols:COL_SIZE, sim_time:100)
