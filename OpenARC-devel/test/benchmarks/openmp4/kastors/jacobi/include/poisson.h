...
static inline void copy_block(int nx, int ny, int block_x, int block_y, double u[MAT_SIZE][MAT_SIZE], double unew[MAT_SIZE][MAT_SIZE], int block_size) {
...
static inline void compute_estimate(int block_x, int block_y, double u[MAT_SIZE][MAT_SIZE],
                                    double unew[MAT_SIZE][MAT_SIZE], double f[MAT_SIZE][MAT_SIZE], double dx,
