...
inputFile="jacobi.c"
inputSize=4096
makeOption="SIZE=${inputSize}"
outputFileBase="${benchmark}_results_${inputSize}"
...
do
	...
	make clean
	make ${makeOption} ROWS_PER_TX=8
	NVLCBatchRun.bash -d=${TARGET} -n=${nItr} -tx
	mv ${outputFileBase}_${TARGET}.txt ${outputFileBase}_8_${TARGET}.txt
