...
//Uncomment below to enable asynchronous execution
//#define ASYNCEXEC
...
#endif
#ifdef ASYNCEXEC
#pragma acc kernels loop independent gang worker collapse(2) copyout(a[0:(M*N)]), copyin(b[0:(M*P)],c[0:(P*N)]) async(0)
#else
